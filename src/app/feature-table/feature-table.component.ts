...
import { payload, FormComponent } from './../form/form.component';
...
export class FeatureTableComponent implements OnInit {
    ...
    constructor (private appService: IssuesService, private router: Router, private formComponent: FormComponent) {
    }
